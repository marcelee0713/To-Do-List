...
/* harmony import */ var _scripts_school__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./scripts/school */ "./src/scripts/school.js");
/* harmony import */ var _scripts_work__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./scripts/work */ "./src/scripts/work.js");
/* harmony import */ var _scripts_personal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./scripts/personal */ "./src/scripts/personal.js");
/* harmony import */ var _scripts_archive__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./scripts/archive */ "./src/scripts/archive.js");
/* harmony import */ var _scripts_ToDoClass__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./scripts/ToDoClass */ "./src/scripts/ToDoClass.js");
...
allNav.addEventListener('click', function () {
  ...
  if (retrievedSchoolData != null) {
    ...
    // Same goes for every module/page.
    _scripts_arrayofobjects__WEBPACK_IMPORTED_MODULE_3__.school.length = 0;
    for (var i = 0; i < retrievedSchoolData.length; i++) {
      ...
      var schoolData = new _scripts_ToDoClass__WEBPACK_IMPORTED_MODULE_8__["default"](category, header, description, dueDate);
      _scripts_arrayofobjects__WEBPACK_IMPORTED_MODULE_3__.school.push(schoolData);
    }
  }
  var retrievedWorkData = JSON.parse(localStorage.getItem("work"));
  if (retrievedWorkData != null) {
    _scripts_arrayofobjects__WEBPACK_IMPORTED_MODULE_3__.work.length = 0;
    for (var _i = 0; _i < retrievedWorkData.length; _i++) {
      var _category = retrievedWorkData[_i].category;
      var _header = retrievedWorkData[_i].header;
      var _description = retrievedWorkData[_i].description;
      var _dueDate = retrievedWorkData[_i].dueDate;
      var workData = new _scripts_ToDoClass__WEBPACK_IMPORTED_MODULE_8__["default"](_category, _header, _description, _dueDate);
      _scripts_arrayofobjects__WEBPACK_IMPORTED_MODULE_3__.work.push(workData);
    }
  }
  var retrievedPersonalData = JSON.parse(localStorage.getItem("personal"));
  if (retrievedPersonalData != null) {
    _scripts_arrayofobjects__WEBPACK_IMPORTED_MODULE_3__.personal.length = 0;
    for (var _i2 = 0; _i2 < retrievedPersonalData.length; _i2++) {
      var _category2 = retrievedPersonalData[_i2].category;
      var _header2 = retrievedPersonalData[_i2].header;
      var _description2 = retrievedPersonalData[_i2].description;
      var _dueDate2 = retrievedPersonalData[_i2].dueDate;
      var personalData = new _scripts_ToDoClass__WEBPACK_IMPORTED_MODULE_8__["default"](_category2, _header2, _description2, _dueDate2);
      _scripts_arrayofobjects__WEBPACK_IMPORTED_MODULE_3__.personal.push(personalData);
    }
  }
  clearOutContainer(content);
  content.appendChild((0,_scripts_all__WEBPACK_IMPORTED_MODULE_2__["default"])());
  content.appendChild((0,_scripts_school__WEBPACK_IMPORTED_MODULE_4__.createSchoolToDo)());
  content.appendChild((0,_scripts_work__WEBPACK_IMPORTED_MODULE_5__.createWorkToDo)());
  content.appendChild((0,_scripts_personal__WEBPACK_IMPORTED_MODULE_6__.createPersonalToDo)());
  for (var _i3 = 1; _i3 < content.childElementCount; _i3++) {
    if (_i3 === 1) {
      content.children[_i3].appendChild((0,_scripts_school__WEBPACK_IMPORTED_MODULE_4__.schoolItemHolder)());
    } else if (_i3 === 2) {
      content.children[_i3].appendChild((0,_scripts_work__WEBPACK_IMPORTED_MODULE_5__.workItemHolder)());
    } else if (_i3 === 3) {
      content.children[_i3].appendChild((0,_scripts_personal__WEBPACK_IMPORTED_MODULE_6__.personalItemHolder)());
    }
  }
...
schoolNav.addEventListener('click', function () {
  ...
  clearOutContainer(content);
  content.appendChild((0,_scripts_school__WEBPACK_IMPORTED_MODULE_4__["default"])(content));
  content.appendChild((0,_scripts_school__WEBPACK_IMPORTED_MODULE_4__.createSchoolToDo)());
  content.lastChild.appendChild((0,_scripts_school__WEBPACK_IMPORTED_MODULE_4__.schoolItemHolder)());
  homeNav.style.backgroundColor = "#1F1F1F";
  allNav.style.backgroundColor = "#1F1F1F";
...
workNav.addEventListener('click', function () {
  ...
  if (retrievedWorkData != null) {
    ...
    for (var i = 0; i < retrievedWorkData.length; i++) {
      ...
      var workData = new _scripts_ToDoClass__WEBPACK_IMPORTED_MODULE_8__["default"](category, header, description, dueDate);
      _scripts_arrayofobjects__WEBPACK_IMPORTED_MODULE_3__.work.push(workData);
    }
  }
  clearOutContainer(content);
  content.appendChild((0,_scripts_work__WEBPACK_IMPORTED_MODULE_5__["default"])(content));
  content.appendChild((0,_scripts_work__WEBPACK_IMPORTED_MODULE_5__.createWorkToDo)());
  content.lastChild.appendChild((0,_scripts_work__WEBPACK_IMPORTED_MODULE_5__.workItemHolder)());
  homeNav.style.backgroundColor = "#1F1F1F";
  allNav.style.backgroundColor = "#1F1F1F";
  schoolNav.style.backgroundColor = "#1F1F1F";
...
personalNav.addEventListener('click', function () {
  var retrievedPersonalData = JSON.parse(localStorage.getItem("work"));
  if (retrievedPersonalData != null) {
    _scripts_arrayofobjects__WEBPACK_IMPORTED_MODULE_3__.personal.length = 0;
    for (var i = 0; i < retrievedPersonalData.length; i++) {
      ...
      var personalData = new _scripts_ToDoClass__WEBPACK_IMPORTED_MODULE_8__["default"](category, header, description, dueDate);
      _scripts_arrayofobjects__WEBPACK_IMPORTED_MODULE_3__.personal.push(personalData);
    }
  }
  clearOutContainer(content);
  content.appendChild((0,_scripts_personal__WEBPACK_IMPORTED_MODULE_6__["default"])(content));
  content.appendChild((0,_scripts_personal__WEBPACK_IMPORTED_MODULE_6__.createPersonalToDo)());
  content.lastChild.appendChild((0,_scripts_personal__WEBPACK_IMPORTED_MODULE_6__.personalItemHolder)());
  homeNav.style.backgroundColor = "#1F1F1F";
  allNav.style.backgroundColor = "#1F1F1F";
  schoolNav.style.backgroundColor = "#1F1F1F";
  workNav.style.backgroundColor = "#1F1F1F";
...
archiveNav.addEventListener('click', function () {
  ...
  if (retrievedArchiveData != null) {
    _scripts_arrayofobjects__WEBPACK_IMPORTED_MODULE_3__.archive.length = 0;
    for (var i = 0; i < retrievedArchiveData.length; i++) {
      ...
      var archiveData = new _scripts_ToDoClass__WEBPACK_IMPORTED_MODULE_8__["default"](category, header, description, dueDate);
      _scripts_arrayofobjects__WEBPACK_IMPORTED_MODULE_3__.archive.push(archiveData);
    }
  }
  clearOutContainer(content);
  content.appendChild((0,_scripts_archive__WEBPACK_IMPORTED_MODULE_7__["default"])(content));
  content.appendChild((0,_scripts_archive__WEBPACK_IMPORTED_MODULE_7__.createDone)());
  content.lastChild.appendChild((0,_scripts_archive__WEBPACK_IMPORTED_MODULE_7__.createHolder)());
  homeNav.style.backgroundColor = "#1F1F1F";
  allNav.style.backgroundColor = "#1F1F1F";
  schoolNav.style.backgroundColor = "#1F1F1F";
  workNav.style.backgroundColor = "#1F1F1F";
...
/******/ })()
;
//# sourceMappingURL=bundle010951dbd048cfe2f11d.js.map