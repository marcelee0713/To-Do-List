export default function inputValidation(cameFromEdit, header, description, date, 
                                        labelHeader, labelSubText, labelDueTime,
                                        inputHeader, inputSubText, inputDueTime){
